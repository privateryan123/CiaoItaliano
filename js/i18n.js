...
const I18n = {
  ...
  translations: {
    en: {
      ...
      directionPosition: 'Direction & Position',
      conversationGlue: 'Core Conversation',
      peopleRoles: 'People & Roles',
      connectors: 'Connectors',
      quantities: 'Quantities',
      everydayAdjectives: 'Everyday Adjectives',
    ...
    de: {
      ...
      months: 'Monate',
      weekdays: 'Wochentage',
      timeSequence: 'Zeit & Reihenfolge',
      directionPosition: 'Richtung & Position',
      conversationGlue: 'Grundkonversation',
      peopleRoles: 'Personen & Rollen',
      connectors: 'Verbindungswörter',
      quantities: 'Mengen',
      everydayAdjectives: 'Alltägliche Adjektive',
